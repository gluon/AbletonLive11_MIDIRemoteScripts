#Embedded file name: /Users/versonator/Jenkins/live/output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/APC40/APC40.py
...
class APC40(APC, OptimizedControlSurface):
    u""" Script for Akai's APC40 Controller """
    ...
    def _create_controls(self):
        ...
        self._shift_button = make_button(0, 98, resource_type=PrioritizedResource, name=u'Shift_Button')
        ...
        self._selected_slot_launch_button = make_pedal_button(67, name=u'Selected_Slot_Launch_Button')
        ...
        for index in range(MIXER_SIZE):
            ...
            self._mute_buttons.append(make_on_off_button(index, 50, name=u'%d_Mute_Button' % index))
            self._select_buttons.append(make_on_off_button(index, 51, name=u'%d_Select_Button' % index))
        ...
        self._master_select_button = make_on_off_button(0, 80, name=u'Master_Select_Button')
        ...
        bank_button_labels = (u'Clip_Track_Button', u'Device_On_Off_Button', u'Previous_Device_Button', u'Next_Device_Button', u'Detail_View_Button', u'Rec_Quantization_Button', u'Midi_Overdub_Button', u'Metronome_Button')
        ...
        self._nudge_down_button = make_button(0, 101, name=u'Nudge_Down_Button')
        ...
        self._global_bank_buttons = [ make_on_off_button(0, 87 + index, name=name) for index, name in enumerate((u'Pan_Button', u'Send_A_Button', u'Send_B_Button', u'Send_C_Button')) ]
    ...
    def _create_device(self):
        self._device = DeviceComponent(name=u'Device_Component', is_enabled=False, layer=Layer(bank_buttons=self._device_bank_buttons, on_off_button=self._device_on_off_button), use_fake_banks=True, device_selection_follows_track_selection=True)
        ChannelTranslationSelector(8, name=u'Control_Translations')
        self._device.set_parameter_controls(tuple(self._device_param_controls_raw))

    def _create_detail_view_control(self):
        self._detail_view_toggler = DetailViewCntrlComponent(name=u'Detail_View_Control', is_enabled=False, layer=Layer(device_clip_toggle_button=self._device_clip_toggle_button, detail_toggle_button=self._detail_toggle_button, device_nav_left_button=self._detail_left_button, device_nav_right_button=self._detail_right_button))
    ...
    def _create_transport(self):
        ...
        self._bank_button_translator = ChannelTranslationSelector(name=u'Bank_Button_Translations', is_enabled=False)
    ...
    def _create_global_control(self):
        ...
        encoder_modes = ModesComponent(name=u'Track_Control_Modes', is_enabled=False)
        ...
        self._translation_selector = ChannelTranslationSelector(name=u'Global_Translations')
