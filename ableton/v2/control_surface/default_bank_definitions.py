...
PARAMETERS_BLACKLIST_FOR_CPP_SANITY_CHECK = {'OriginalSimpler':('Start', 'End', 'Sensitivity', 'Mode', 'Playback', 'Pad Slicing', 'Multi Sample',
 'Warp', 'Warp Mode', 'Voices', 'Preserve', 'Loop Mode', 'Envelope', 'Grain Size Tones',
 'Grain Size Texture', 'Flux', 'Formants', 'Envelope Complex Pro', 'Gain'), 
 'InstrumentVector':('Osc 1 Effect Type', 'Osc 2 Effect Type', 'Osc 1 Table', 'Osc 2 Table', 'Osc 1 Category',
 'Osc 2 Category', 'Osc 1 Pitch', 'Osc 2 Pitch', 'Unison Mode', 'Mono On'), 
