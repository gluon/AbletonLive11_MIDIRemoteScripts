...
# Embedded file name: ..\..\..\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\resource.py
...
class StackingResource(Resource):
    ...
    def _add_client(self, client, priority):
        idx = index_if(lambda client_and_priority: client_and_priority[1] > priority
, self._clients)
        self._clients.insert(idx, (client, priority))

    def _remove_client(self, client):
        idx = index_if(lambda client_and_priority: client_and_priority[0] == client
, self._clients)
