...
# Embedded file name: output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Launchkey_MK2/Launchkey_MK2.py
    ...
    def handle_sysex(self, midi_bytes):
        if self._is_identity_response(midi_bytes):
            ...
            if self._is_identity_response_valid(product_id_bytes):
                ...
                self.log_message('MIDI device responded with wrong product id (%s).' % (
