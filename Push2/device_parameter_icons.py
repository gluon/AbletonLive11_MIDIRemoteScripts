...
IMAGE_ID_TO_FILENAME = {
  ...
  'wave_triangle': ('wave_triangle.svg', ''),
...
# Embedded file name: output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Push2/device_parameter_icons.py
# Compiled at: 2022-01-28 05:06:23
# Size of source mod 2**32: 35733 bytes
from __future__ import absolute_import, print_function, unicode_literals
IMAGE_ID_TO_FILENAME = {'amp_bass':('amp_bass.svg', ''), 
 'amp_blues':('amp_blues.svg', ''), 
 'amp_boost':('amp_boost.svg', ''), 
 'amp_clean':('amp_clean.svg', ''), 
 'amp_heavy':('amp_heavy.svg', ''), 
...
DEVICE_PARAMETER_IMAGES = {'UltraAnalog':{
...
GENERIC_PARAMETER_IMAGES = {'LFO Waveform':LFO_WAVEFORMS, 
 ...
 'Side Listen':ACTIVATE, 
 'EQ On':ACTIVATE, 
 'EQ Mode':('filter_low_shelf', 'filter_bell', 'filter_high_shelf', 'filter_low_48', 'filter_band_24',
 'filter_high_48')}
DEVICE_PARAMETER_IMAGES = {'UltraAnalog':{'OSC1 On/Off':ACTIVATE, 
 ...
 'InstrumentImpulse':{'1 Filter Type':IMPULSE_FILTERS, 
  ...
  '7 Filter Type':IMPULSE_FILTERS, 
  '8 Filter Type':IMPULSE_FILTERS}, 
 'StringStudio':{'Excitator Type':('tension_bow', 'tension_hammer', 'tension_hammerbounce', 'tension_plectrum'), 
  'Filter Type':('filter_low_12', 'filter_low_24', 'filter_band_6', 'filter_band_12', 'filter_notch_12',
 'filter_notch_24', 'filter_high_12', 'filter_high_24', 'filter_formant_6', 'filter_formant_12'), 
  ...
  'LFO Sync On':SYNC, 
  'LFO Shape':('wave_sine', 'wave_triangle', 'wave_square', 'wave_sh_mono', 'wave_noise_white')}, 
 'Operator':{'Oscillator':('osc_a', 'osc_b', 'osc_c', 'osc_d'), 
  'Algorithm':('osc_alg_1', 'osc_alg_2', 'osc_alg_3', 'osc_alg_4', 'osc_alg_5', 'osc_alg_6', 'osc_alg_7',
 'osc_alg_8', 'osc_alg_9', 'osc_alg_10', 'osc_alg_11'), 
  'Filter Type':CYTOMIC_FILTER_TYPES, 
  'Filter Circuit - LP/HP':FILTER_CIRCUIT_TYPES, 
  'Filter Circuit - BP/NO/Morph':FILTER_CIRCUIT_TYPES, 
  'LFO Type':('wave_sine', 'wave_square', 'wave_triangle', 'wave_saw_up', 'wave_saw_down', 'wave_sh_mono',
 'wave_noise_white'), 
  'Osc-A Wave':OPERATOR_OSCILLATORS, 
  'Osc-B Wave':OPERATOR_OSCILLATORS, 
  'Osc-C Wave':OPERATOR_OSCILLATORS, 
...
=======
 ...
 'wave_noise_white'), 
  ...
  'Note Off':ACTIVATE, 
  'Filter On/Off':ACTIVATE}, 
 'Delay':{'L 16th':('delay_16th_1', 'delay_16th_2', 'delay_16th_3', 'delay_16th_4', 'delay_16th_5', 'delay_16th_6',
 'delay_16th_8', 'delay_16th_16'), 
  'R 16th':('delay_16th_1', 'delay_16th_2', 'delay_16th_3', 'delay_16th_4', 'delay_16th_5', 'delay_16th_6',
 'delay_16th_8', 'delay_16th_16'), 
  'Channel':('utility_stereo', 'utility_left', 'utility_right'), 
  'Link Switch':('utility_stereo', 'utility_left'), 
  'L Sync Enum':SYNC, 
 ...
 'Echo':{'L Sync Mode':('echo_note', 'echo_triplet', 'echo_dotted', 'echo_16th'), 
  'R Sync Mode':('echo_note', 'echo_triplet', 'echo_dotted', 'echo_16th'), 
  'Mod Wave':('lfo_sine_small', 'lfo_triangle_small', 'lfo_saw_up_small', 'lfo_saw_down_small',
 'lfo_square_small', 'lfo_random_small'), 
  'Link':ACTIVATE, 
  'Ping Pong':ACTIVATE, 
  'Repitch':ACTIVATE, 
  'Filter On':ACTIVATE, 
  'Mod Sync':ACTIVATE}, 
 'Eq8':{'Band':('eq8_band1', 'eq8_band2', 'eq8_band3', 'eq8_band4', 'eq8_band5', 'eq8_band6', 'eq8_band7',
 'eq8_band8'), 
  '1 Filter Type A':EQ8_FILTER_TYPES, 
  '2 Filter Type A':EQ8_FILTER_TYPES, 
  '3 Filter Type A':EQ8_FILTER_TYPES, 
...
=======
 ...
 'hybrid_reverb_type_tides', 'hybrid_reverb_type_prism'), 
  'Vintage Copy':('hybrid_reverb_vintage_1', 'hybrid_reverb_vintage_2', 'hybrid_reverb_vintage_3', 'hybrid_reverb_vintage_4',
 'hybrid_reverb_vintage_5'), 
  'Routing Eq Off':('hybrid_reverb_routing_serial', 'hybrid_reverb_routing_parallel', 'hybrid_reverb_routing_algo',
 'hybrid_reverb_routing_convo'), 
  'Routing Eq On PreAlgo Off':('hybrid_reverb_routing_serial_eq', 'hybrid_reverb_routing_parallel_eq', 'hybrid_reverb_routing_algo_eq',
 'hybrid_reverb_routing_convo_eq'), 
  'Routing Eq On PreAlgo On':('hybrid_reverb_routing_serial_eq_pre_algo', 'hybrid_reverb_routing_parallel_eq_pre_algo',
 'hybrid_reverb_routing_algo_eq_pre_algo', 'hybrid_reverb_routing_convo_eq_pre_algo')}, 
 'InstrumentVector':{'Oscillator':WAVETABLE_OSCILLATOR_SWITCH, 
  ...
  'LFO 2 Retrigger':ACTIVATE, 
  'Mono On':ACTIVATE, 
  'Unison Mode':('wavetable_unison_none', 'wavetable_unison_classic', 'wavetable_unison_shimmer', 'wavetable_unison_noise',
