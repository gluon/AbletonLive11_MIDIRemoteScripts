#Embedded file name: /Users/versonator/Jenkins/live/output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Push2/mute_solo_stop.py
...
class TrackStateColorIndicator(EventObject):
    color = listenable_property.managed(u'DefaultButton.On')
    ...
    def __init__(self, item_provider = None, track_property = None, property_active_color = None, song = None, *a, **k):
        ...
        self.register_slot(MultiSlot(listener=self.__on_property_changed, event_name_list=(u'selected_item', track_property), subject=item_provider))
        self._update_color()
    ...
    def _update_color(self):
        ...
        self.color = self._active_color if use_active_color else u'DefaultButton.On'
...
class MuteSoloStopClipComponent(Component, Messenger):
    ...
    @listens_group(u'mute_solo_stop_cancel_action_performed')
    def __on_mute_solo_stop_cancel_action_performed(self, _):
        self.cancel_release_actions()

    @listens_group(u'mode_locked')
    ...
    def _show_mode_lock_change_notification(self, is_locked, mode):
        ...
        message_part = u'Locked' if is_locked else u'Unlocked'
