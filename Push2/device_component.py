...
# Embedded file name: output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Push2/device_component.py
...
import ableton.v2.control_surface as DeviceProviderBase
