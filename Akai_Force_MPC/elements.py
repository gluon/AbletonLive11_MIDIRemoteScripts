...
# Embedded file name: output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Akai_Force_MPC/elements.py
...
import ableton.v2.control_surface.elements as ButtonMatrixElementBase
