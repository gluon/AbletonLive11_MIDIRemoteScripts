#Embedded file name: /Users/versonator/Jenkins/live/output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/pushbase/elements.py
...
class Elements(object):
    ...
    def __init__(self, deleter = None, undo_handler = None, pad_sensitivity_update = None, playhead = None, velocity_levels = None, continuous_mapping_sensitivity = None, fine_grained_continuous_mapping_sensitivity = None, full_velocity = None, *a, **k):
        ...
        self.nav_down_button = create_button(47, u'Down_Arrow')
        self.nav_left_button = create_button(44, u'Left_Arrow')
        self.nav_right_button = create_button(45, u'Right_Arrow')
        self.shift_button = create_modifier_button(49, u'Shift_Button')
        self.select_button = create_modifier_button(48, u'Select_Button')
        self.delete_button = create_modifier_button(118, u'Delete_Button', undo_step_handler=undo_handler)
        self.duplicate_button = create_modifier_button(88, u'Duplicate_Button', undo_step_handler=undo_handler)
        self.quantize_button = create_modifier_button(116, u'Quantization_Button', undo_step_handler=undo_handler)
        self.accent_button = create_modifier_button(57, u'Accent_Button')
        self.in_button = create_button(62, u'In_Button')
        self.out_button = create_button(63, u'Out_Button')
        self.master_select_button = create_button(28, u'Master_Select_Button')
        self.octave_down_button = create_button(54, u'Octave_Down_Button')
        self.octave_up_button = create_button(55, u'Octave_Up_Button')
        self.repeat_button = create_button(56, u'Repeat_Button')
        self.global_mute_button = create_modifier_button(60, u'Global_Mute_Button')
        self.global_solo_button = create_modifier_button(61, u'Global_Solo_Button')
        self.global_track_stop_button = create_modifier_button(29, u'Track_Stop_Button')
        self.scale_presets_button = create_button(58, u'Scale_Presets_Button')
        self.vol_mix_mode_button = create_button(114, u'Vol_Mix_Mode_Button')
        self.device_mode_button = create_button(110, u'Device_Mode_Button')
        self.clip_mode_button = create_button(113, u'Clip_Mode_Button')
        self.browse_mode_button = create_button(111, u'Browse_Mode_Button')
        self.single_track_mix_mode_button = create_button(112, u'Single_Track_Mode_Button')
        self.pan_send_mix_mode_button = create_button(115, u'Pan_Send_Mode_Button', resource_type=PrioritizedResource)
        self.note_mode_button = create_modifier_button(50, u'Note_Mode_Button')
        self.session_mode_button = create_button(51, u'Session_Mode_Button')
        self.play_button = create_button(85, u'Play_Button')
        self.new_button = create_button(87, u'New_Button')
        self.automation_button = create_button(89, u'Automation_Button')
        self.tap_tempo_button = create_button(3, u'Tap_Tempo_Button')
        self.metronome_button = create_button(9, u'Metronome_Button')
        self.fixed_length_button = create_button(90, u'Fixed_Length_Button')
        self.record_button = create_modifier_button(86, u'Record_Button')
        self.undo_button = create_button(119, u'Undo_Button')
        self.create_device_button = create_button(52, u'Create_Device_Button', undo_step_handler=undo_handler)
        ...
        self.single_press_event_matrix = ButtonMatrixElement(name=u'Single_Press_Event_Matrix', rows=recursive_map(lambda x: x.single_press, double_press_rows))
        self.double_press_event_matrix = ButtonMatrixElement(name=u'Double_Press_Event_Matrix', rows=recursive_map(lambda x: x.double_press, double_press_rows))
        self.tempo_control_tap = create_note_button(10, u'Tempo_Control_Tap')
        self.tempo_control = TouchEncoderElement(channel=0, identifier=14, map_mode=consts.GLOBAL_MAP_MODE, name=u'Tempo_Control', undo_step_handler=undo_handler, delete_handler=deleter, encoder_sensitivity=BASE_ENCODER_SENSITIVITY, touch_element=self.tempo_control_tap)
        self.swing_control_tap = create_note_button(9, u'Swing_Control_Tap')
        self.swing_control = TouchEncoderElement(channel=0, identifier=15, map_mode=consts.GLOBAL_MAP_MODE, name=u'Swing_Control', undo_step_handler=undo_handler, delete_handler=deleter, encoder_sensitivity=BASE_ENCODER_SENSITIVITY, touch_element=self.swing_control_tap)
        self.master_volume_control_tap = create_note_button(8, u'Master_Volume_Tap')
        self.master_volume_control = TouchEncoderElement(channel=0, identifier=79, map_mode=consts.GLOBAL_MAP_MODE, undo_step_handler=undo_handler, delete_handler=deleter, name=u'Master_Volume_Control', encoder_sensitivity=BASE_ENCODER_SENSITIVITY, touch_element=self.master_volume_control_tap)
