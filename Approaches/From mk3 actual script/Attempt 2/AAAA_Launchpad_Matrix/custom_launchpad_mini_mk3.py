...
from .custom_session_overview import CustomSessionOverviewComponent
...
class Custom_Launchpad_Mini_MK3(NovationBase):
    ...
    def __init__(self, *a, **k):
        ...
        super(Custom_Launchpad_Mini_MK3, self).__init__(*a, **k)
    ...
    def on_identified(self, midi_bytes):
        ...
        super(Custom_Launchpad_Mini_MK3, self).on_identified(midi_bytes)

    def _create_components(self):
        super(Custom_Launchpad_Mini_MK3, self)._create_components()
    ...
    def _create_session_layer(self):
        pass
        # return super(Custom_Launchpad_Mini_MK3, self)._create_session_layer() + Layer(
    ...
    def _create_session_modes(self):
        self._session_overview = CustomSessionOverviewComponent(
    ...
    def _create_background(self):
        self._background = NotifyingBackgroundComponent(
            ...
            layer=Layer(
                drums_mode_button=u"drums_mode_button",
