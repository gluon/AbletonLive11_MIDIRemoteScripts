#Embedded file name: /Users/versonator/Jenkins/live/output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Launchpad_MK2/Launchpad_MK2.py
...
class Launchpad_MK2(IdentifiableControlSurface, OptimizedControlSurface):
    ...
    def _create_mixer(self):
        self._mixer = MixerComponent(is_enabled=False, num_tracks=consts.SESSION_WIDTH, invert_mute_feedback=True, enable_skinning=True, name=u'Mixer', is_root=True)
    ...
    def _create_modes(self):
        ...
        self._modes.add_mode(u'session_mode', [self._session, self._session_layer_mode], layout_byte=0, behaviour=EnablingReenterBehaviour(self._session_zoom))
        self._modes.add_mode(u'user_1_mode', [], layout_byte=1)
